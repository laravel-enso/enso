...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        axios.get(route('system.permissions.create', null, false)).then(function (_ref) {
            var data = _ref.data;
